<?php 
	...
	$sql = "SELECT id, firstName, lastName,  points FROM employee, erank WHERE erank.eid = employee.id order by erank.points desc";
	$sql1 = "SELECT pname, duedate FROM project WHERE eid = $id and pstatus = 'Due'";
...
<html>
<head>
	<title>Employee Panel | CROWN Corporation</title>
