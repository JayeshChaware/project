...
if(isset($_POST['update']))
{
  ...
  $result = mysqli_query($conn, "select employee.epassword from employee WHERE id = $id");
     $employee = mysqli_fetch_assoc($result);
          if($old == $employee['epassword']){
            $sql = "UPDATE employee SET epassword='$new' WHERE id = $id";
...
<html>
<head>
  <title>Change Password | CROWN Corporation</title>
  <!-- Icons font CSS-->
