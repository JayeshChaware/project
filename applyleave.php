...
<html>
<head>
	<title>Apply Leave | Employee Panel | CROWN Corporation</title>
...
<body bgcolor="#F0FFFF">
	...
	<table>
			...
			<?php
				...
				$sql = "Select employee.id, employee.firstName, employee.lastName, employee_leave.lstart, employee_leave.lend, employee_leave.reason, employee_leave.lstatus From employee, employee_leave Where employee.id = $id and employee_leave.id = $id order by employee_leave.token";
				$result = mysqli_query($conn, $sql);
